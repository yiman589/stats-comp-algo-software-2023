...
**Answer:** Since I am using Macbook M1 chip, I don't think the flags are supported by my computer when I input the code given in the Makevars file (as discussed on Slack). Time costs for any flags are around 60ms, so no time differences are noticed. 
